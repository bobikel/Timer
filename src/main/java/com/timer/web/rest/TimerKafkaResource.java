...
@RestController
@RequestMapping("/api/timer-kafka")
public class TimerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TimerKafkaResource.class);
    ...
    public TimerKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
